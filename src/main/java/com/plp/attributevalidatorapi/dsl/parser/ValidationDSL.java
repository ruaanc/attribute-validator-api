...
public class ValidationDSL implements ValidationDSLConstants {
 ...
 Program response;
  ...
  static final public Expression PValidateZipCode() throws ParseException {
  Expression response;
    jj_consume_token(CEP);
    response = PPrimaryExp();
    {if (true) return new ValidateZipCode(response);}
    throw new Error("Missing return statement in function");
  }

  static final public Expression PValidateCnpj() throws ParseException {
  Expression response;
    jj_consume_token(CNPJ);
    response = PPrimaryExp();
    {if (true) return new ValidateCnpj(response);}
    throw new Error("Missing return statement in function");
  }

  static final public Expression PValidateCpf() throws ParseException {
  Expression response;
    jj_consume_token(CPF);
    response = PPrimaryExp();
    {if (true) return new ValidateCpf(response);}
    throw new Error("Missing return statement in function");
  }

  static final public Expression PValidateName() throws ParseException {
  Expression response;
    jj_consume_token(NAME);
    response = PPrimaryExp();
  {if (true) return new ValidateName(response);}
    throw new Error("Missing return statement in function");
  }

  static final public Expression PValidateEmail() throws ParseException {
  Expression response;
    jj_consume_token(EMAIL);
    response = PPrimaryExp();
  {if (true) return new ValidateEmail(response);}
    throw new Error("Missing return statement in function");
  }
